...
const BarChats = () => {
  return (
    <section className="pt-12 px-10 font-poppins">
      ...
      <div className="grid grid-cols-5 gap-7 w-[80%]">
        <div className="left col-span-2  h-[75vh] flex flex-col rounded-lg border px-5 py-6 shadow-2xl">
          ...
          <div className="flex-grow space-y-4 overflow-y-auto pr-4 custom-scrollbar">
            {Array(12)
              .fill(null)
              .map((_, idx) => (
                <div className="flex gap-2 rounded bg-[#F8F8F8] p-4" key={idx}>
                  <figure className="size-10 overflow-hidden rounded-full shrink-0">
                    <img
        ...
        <div className="right col-span-3  h-[75vh] flex flex-col rounded-lg border px-5 py-6 shadow-2xl">
          <div className="flex gap-2 rounded border-b px-4 text-[#161C24CC] pb-3 mb-3">
          ...
          <div className="mt-4 gap-2 rounded bg-[#F8F8F8]">
            <fieldset className="relative">
              ...
              />
              <button>
                <AiOutlineSend className="absolute right-4 top-1/2 size-6 -translate-y-1/2 text-[#919EAB]" />
              </button>
            </fieldset>
          </div>
        </div>
