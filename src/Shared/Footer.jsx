...
const Footer = () => {
  return (
    <footer className="bg-[#181818] pt-[141px] pb-[96px]">
      <Container>
        <div className="flex justify-between pb-[87px] border-b border-[#B5B5B5]">
          <div className="">
            <figure>
          ...
          <ul className="flex flex-col gap-[21px] cursor-pointer">
          ...
          <div className="flex flex-col gap-[21px] max-w-[394px]">
            ...
            <div className="relative">
              <input
                ...
                className="outline-none border border-[#DBA514] rounded-[8px] py-[14.5px] pl-6 text-[#888] text-[16px] font-normal w-full"
              />
        ...
        <p className="text-center text-[16px]  font-normal text-[#FFF]  capitalize pt-[30px]">© 2024 SipSavvy.com, LLC. All rights reserved.</p>
      </Container>
    </footer>
  );
};
