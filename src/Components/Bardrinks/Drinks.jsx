...
const Drinks = ({ receipt, setReceipt }) => {
  ...
  const handleBtn = () => {
    ...
    const totalPrice =
      input2 > 1
        ? (parseFloat(input2) * parseFloat(selectedDrink.price)).toFixed(2)
        : selectedDrink.price;
  ...
  const drinksinfo = [
    {
      id: 1,
      title: "Vermouth",
      image: "src/assets/images/Logo/bottle.png",
  ...
  return (
    <section className="bg-[#FFF] py-[100px]">
      <Container>
        ...
        <div className="grid grid-cols-3 gap-5 relative">
          {drinksinfo.map((item, index) => (
            <div
              key={index}
              className="pt-[37px] px-[20px] pb-[20px] border-[0.5px] border-[#DBA514]/30 rounded-[6px] relative cursor-pointer group"
            >
      ...
      {selectedDrink && (
        ...
        >
          <div
            className="bg-white pt-[30px] pb-[40px] pl-[58px] pr-[91px] rounded-lg relative w-[651px] z-50 h-[850px]"
          ...
          >
            ...
            <div className="flex gap-x-8">
              ...
              <div>
                ...
                <p className="text-[24px] text-[#000] font-semibold">
                  {input2 > 1
                    ? `$${(input2 * parseFloat(selectedDrink.price)).toFixed(
                        2
                      )}`
                    : `$${selectedDrink.price}`}
                </p>
            ...
            <div className="flex justify-center">
              <button
                onClick={handleBtn}
                className="flex justify-center items-center leading-none py-[18px] px-[90px] mt-[50px] capitalize font-semibold text-[18px] rounded-lg bg-[linear-gradient(92deg,_#DBA514_2.3%,_#EEB609_35.25%,_#C69320_66.76%,_#FCC201_97.79%)] backdrop-blur-[6.5px] text-[#0E0E0E] cursor-pointer tracking-[0.72px]"
              >
                Order Now
              </button>
            </div>
