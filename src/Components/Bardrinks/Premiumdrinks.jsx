...
const Premiumdrinks = () => {
  ...
  const Premiumdrinksinfo = [
    {
      id: 1,
      title: "Vermouth",
      image: "src/assets/images/Bar/premiumbottle.png",
  ...
  return (
    <section className="bg-[#1F1F1F] pt-[60px] pb-[142px]">
        ...
        <div className="grid grid-cols-3 gap-6">
          {Premiumdrinksinfo?.map((item, index) => (
            ...
            >
              ...
              <h4 className="text-[20px] text-[#FFF] font-normal font-instrument py-[6px] leading-none">
                {item.description}
              </h4>
      ...
      {selectedDrink && (
        ...
        >
          <div
            className="bg-white pt-[75px] pb-[100px] pl-[58px] pr-[91px] rounded-lg relative w-[651px] z-50 h-[900px]"
