...
const Checkout = ({ setPopUp2, setReceipt, setSelectedDrink }) => {
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-4 justify-between">
                      <div className="flex flex-col gap-1">
                        ...
                        <input
                          ...
                          name=""
                          id=""
                          className="border border-[#C8C8C8] rounded-[6px] gap-x-8 outline-none p-3 bg-[#FFF] w-[230px]"
                        />
                      </div>
                      <div className="flex flex-col gap-1">
                        <p className="text-[16px] font-medium text-[#353B48]">
                      ...
                      <div className="flex flex-col gap-1">
                        <p
                          classNaCard
                          nme="text-[16px] font-medium text-[#353B48]"
                        >
                          CCV
                        </p>
                        <input
                  ...
                  <div className="flex flex-col gap-3 mt-[31px] ">
                    <div className="flex gap-x-4 items-center">
                      <input
                        type="checkbox"
                        className="w-4 h-4 border border-[#5C5C5C] rounded-[2px] cursor-pointer"
                      />
                      <p className="text-[16px] text-[#222F3E] font-normal">
