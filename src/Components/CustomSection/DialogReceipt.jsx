...
const DialogReceipt = ({ receipt, setReceipt }) => {
  ...
  useEffect(() => {
    const savedReceipt = localStorage.getItem("orderDetails");
      ...
      <Dialog open={receipt} onOpenChange={setReceipt}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              <div className="flex gap-6 mb-12 pt-2">
                ...
                <div className="right text-[#0E0E0E] space-y-3">
                  ...
                  <p>Table no : 05</p>
                  <p>Date : 02 Jan , 2024</p>
                </div>
              </div>
              <div className="flex flex-col items-center pb-2">
                <img
                  src="https://i.ibb.co.com/Nw6QSX9/image.png"
                  alt=""
      ...
      {popup3 && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white pt-[67px] pb-[111px] px-[53px] rounded-lg relative w-[651px] z-50">
            ...
            <div className="flex justify-center">
              <Link to="/bar-drinks">
                <button onClick={() => setPopup3(false)} className="flex justify-center items-center leading-none py-[18px] px-[90px] mt-[100px] capitalize font-semibold text-[18px] rounded-lg bg-[linear-gradient(92deg,_#DBA514_2.3%,_#EEB609_35.25%,_#C69320_66.76%,_#FCC201_97.79%)] backdrop-blur-[6.5px] text-[#0E0E0E] cursor-pointer tracking-[0.72px]">
                  Confirm
                </button>
              </Link>
            </div>
